...
# Display banner
echo "════════════════════════════════════════════════════════"
echo "🌳 Worktree: user-preferences-dashboard-integration---build-ui"
echo "📋 Task: ||user-preferences-dashboard-integration---build-ui User Preferences Dashboard Integration - Build UI for scenario input (26 variables), model training panel, trade-off visualization, job preview (12-16 hours, backend complete)"
echo "════════════════════════════════════════════════════════"
echo ""
