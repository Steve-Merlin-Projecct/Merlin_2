...
# Display banner
echo "════════════════════════════════════════════════════════"
echo "🌳 Worktree: gemini-prompt-optimization-phase-2---implement-pro"
echo "📋 Task: ||gemini-prompt-optimization-phase-2---implement-pro Gemini Prompt Optimization Phase 2 - Implement prompt refinements with 30-40% cost reduction (security token consolidation, JSON schema optimization, A/B testing) (3-4 weeks)"
echo "════════════════════════════════════════════════════════"
echo ""
